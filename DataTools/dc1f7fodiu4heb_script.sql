-----------------------
-- Obligatoir : PostgreSql 12.3
-- DB : dc1f7fodiu4heb
-- destruction & creation de la BD à partir de :
-- https://data.heroku.com/datastores/e001e625-8fb5-4584-8342-3265e839ff61#administration
-----------------------
...
-- commande : pg_dump -U postgres --column-inserts -p 5433 -d dc1f7fodiu4heb > C:\Users\pc\Desktop\testBackup.sql
-- -U : postgres : Username 
