    ...
    k.prototype = {
        ...
        _process_options: function (e) {
            ...
            (f.startView = Math.min(f.startView, f.maxViewMode)),
                ...
                f.multidate !== !0 &&
                    ...
                    f.multidate !== !1 &&
                        (f.multidate = Math.max(0, f.multidate))),
            ...
            if (
                (f.startDate !== -(1 / 0) &&
                    (f.startDate
                        ? f.startDate instanceof Date
                            ? (f.startDate = this._local_to_utc(
                                  this._zero_time(f.startDate)
                              ))
                            : (f.startDate = r.parseDate(
                                  f.startDate,
                                  h,
                                  f.language
                              ))
                    ...
                    (f.endDate
                        ? f.endDate instanceof Date
                            ? (f.endDate = this._local_to_utc(
                                  this._zero_time(f.endDate)
                              ))
                            : (f.endDate = r.parseDate(
                                  f.endDate,
                                  h,
                                  f.language
                              ))
                ...
                a.isArray(f.daysOfWeekDisabled) ||
                    (f.daysOfWeekDisabled = f.daysOfWeekDisabled.split(
                        /[,\s]*/
                    )),
                (f.daysOfWeekDisabled = a.map(f.daysOfWeekDisabled, function (
                    a
                ) {
                ...
                a.isArray(f.daysOfWeekHighlighted) ||
                    (f.daysOfWeekHighlighted = f.daysOfWeekHighlighted.split(
                        /[,\s]*/
                    )),
                (f.daysOfWeekHighlighted = a.map(
                    f.daysOfWeekHighlighted,
                    function (a) {
                        return parseInt(a, 10);
                    }
                )),
        ...
        getClassNames: function (b) {
            ...
            return (
                ...
                (b.valueOf() < this.o.startDate ||
                    ...
                    -1 !==
                        a.inArray(b.getUTCDay(), this.o.daysOfWeekDisabled)) &&
                    c.push("disabled"),
        ...
        fill: function () {
            ...
            if (!isNaN(f) && !isNaN(g)) {
                ...
                o.setUTCDate(p),
                    o.setUTCDate(
                        p - ((o.getUTCDay() - this.o.weekStart + 7) % 7)
                    );
                var s = new Date(o);
                o.getUTCFullYear() < 100 &&
                    s.setUTCFullYear(o.getUTCFullYear()),
                ...
                for (var t, u = []; o.valueOf() < s; ) {
                    if (
                        ...
                        var v = new Date(
                                +o +
                                    ((this.o.weekStart - o.getUTCDay() - 7) %
                                        7) *
                                        864e5
                            ),
                            w = new Date(
                                Number(v) + ((11 - v.getUTCDay()) % 7) * 864e5
                            ),
                            x = new Date(
            ...
            parseDate: function (d, e, f) {
                ...
                if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(d)) {
                    for (d = new Date(), j = 0; j < m.length; j++)
                        switch (
                            ((h = l.exec(m[j])), (i = parseInt(h[1])), h[2])
                        ) {
                            case "d":
                                d.setUTCDate(d.getUTCDate() + i);
                                break;
                            case "m":
                                d = k.prototype.moveMonth.call(
                                    k.prototype,
                                    d,
                                    i
                                );
